from tkinter import GROOVE, RAISED, SUNKEN, Button, Label
import random
...
class Cell:
    ...
    def show_mine(self):
        ...
        ctypes.windll.user32.MessageBoxW(0, "Mine Clicked", 'You Lost', 0)
        sys.exit()
